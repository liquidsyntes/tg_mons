...
ФОРМАТ ОТВЕТА (JSON)
Ответь СТРОГО в формате валидного JSON объекта по следующей схеме (БЕЗ использования markdown-блоков, просто чистый JSON. Внимательно следи за скобками и запятыми, не допускай синтаксических ошибок):
{
  "stats": [
...
`;
    ...
    await saveAiReport(Number(channelId), 'super_report', result);
