...
import { Sparkles, Layers, Calendar, ChevronRight, FileText, Zap, Loader2 } from 'lucide-react';
    ...
    <div className="pb-24">
      ...
      <div className="grid gap-3">
        {reports.map(report => {
          ...
          const Icon = report.type === 'summary' ? Sparkles : report.type === 'evolution' ? Zap : Layers;
          const colorClass = report.type === 'summary' 
            ? 'text-amber-400 bg-amber-400/10' 
            : report.type === 'evolution'
              ? 'text-emerald-400 bg-emerald-400/10'
              : 'text-violet-400 bg-violet-400/10';
          const title = report.type === 'summary' ? 'Контент-анализ' : report.type === 'evolution' ? 'Динамика изменений' : 'Сравнение с конкурентом';
